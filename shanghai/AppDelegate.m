...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [self launchCatalogBusyState:NO];    return YES;
}
...
-(void)launchCatalogBusyState:(BOOL)busy {
    ...
    [window makeKeyAndVisible];
     ...
     [nLVC.navigationController popToRootViewControllerAnimated:NO];     // without animation this gives the appearance of letting the Dejal indicator to show up
     } else {
     [DejalBezelActivityView removeViewAnimated:YES];
     
     [nLVC.navigationController popToRootViewControllerAnimated:YES];
     }
